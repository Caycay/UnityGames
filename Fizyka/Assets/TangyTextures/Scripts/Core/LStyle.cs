...
namespace TangyTextures
{
		...
		*/
		public class LStyle
		{
				...
				public static string PresetsFilename = "Assets/TangyTextures/Data/Presets/presets.dat";
				public static string SnippetDirectory = "Assets/TangyTextures/Data/Snippets/";
				public static string TerrainDirectory = "Assets/TangyTextures/Data/Terrains/";
			...
			"WTF"
				...
				public static string Filetype = "tex";
				public static string TextureGameobjectName = "TangyTextures";
