...
{
/*
* Main editor class for TangyTextures. Displays nodes, buttons, maintains everyhing. You know it, baby!
*
*/
		public class TangyTexturesEditor : CNodeManager
		{
			...
			"<size=24>" + LStyle.hexColors [1] + "TangyTextures procedural material generator </color></size>\n" +
						"<size=16>" + LStyle.hexColors [2] + "by LemonSpawn </color></size>\n" +
						"<size=12>" + LStyle.hexColors [3] + "http://www.lemonspawn.com </color></size>\n" +
						"\n" +
						"\n" +
						"TangyTextures is a node-based procedural material generator extension for Unity, developed by LemonSpawn. \n\n" +
				...
				// Define menu item
				[MenuItem ("Window/LemonSpawn/TangyTextures Generator")]
				static void Init ()
				{
						window = EditorWindow.GetWindow (typeof(TangyTexturesEditor));
				}
				...
				{
						if (logo == null) {
								logo = (Texture2D)Resources.Load ("TangyTexturesLogo", typeof(Texture2D));
						}
...
*/			
				...
				public TangyTexturesEditor () : base()
				{
